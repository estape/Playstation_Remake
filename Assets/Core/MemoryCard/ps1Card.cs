...
namespace MemcardRex
{
    class ps1card
    {
        ...
        public System.Drawing.Color[,] iconPalette = new System.Drawing.Color[15, 16];

        //public Bitmap[,] iconData = new Bitmap[15, 3];

        //Memory Card icon data, 15 slots, 3 icons per slot, (16*16px icons)
        public Texture2D[,] iconData = new Texture2D[15, 3];
        ...
        private UnityEngine.Color ConvertDrawingColorToUnityColor(System.Drawing.Color color)
        {
        ...
        private void loadIcons()
        {
            ...
            for (int slotNumber = 0; slotNumber < 15; slotNumber++)
            {
                ...
                {
                    iconData[slotNumber, iconNumber] = new Texture2D(16, 16);
                    ...
                    for (int y = 0; y < 16; y++)
                    {
                        for (int x = 0; x < 16; x += 2)
                        {
                            ...
                            //Está usando UnityEngine.Color
                            iconData[slotNumber, iconNumber].SetPixel(x, y, unityColor1);
                            iconData[slotNumber, iconNumber].SetPixel(x + 1, y, unityColor2);
                            byteCount++;
                        }
                    }
                    iconData[slotNumber, iconNumber].Apply();
                }
            }
        }
